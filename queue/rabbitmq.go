...
func NewRabbitMQ(ctx context.Context, config *RabbitMQConfig) (*RabbitMQ, error) {
	...
	var maxPriority uint8 = 9 // 最大是9
	if config.MaxPriority == nil || *config.MaxPriority > maxPriority {
		config.MaxPriority = &maxPriority
	}
